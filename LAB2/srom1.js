...
function compareBin(num1, num2){
    let maxlength = Math.max(num1.length, num2.length);

    if(num1.length < num2.length)
        num1 = addO(num1, num2)[0];
    else
        num2 = addO(num2, num1)[0];
...
function binaryDiv(bin1, bin2){
    ...
    for(let i = 0; i < bin1.length; i++){
        if(compareBin(r, bin2) === 1 || compareBin(r, bin2) === 0)
            break;

        r += bin1[i];

        if(compareBin(r, bin2) === -1){
            result += 0;
        }else{
            r = binarySub(r, bin2);
            result += 1;
...
function findBinFraction(bin, module) {
    if (compareBin(bin, binaryMul(module, module)) !== 1) {
        console.log("barr")
...
let a = new BigNumber("94ede1a444b9738adf06cdb40dcafa87b25a8beca2d2262a53d8431a119405f0cbefb83d2ad547cce3ae74a8ec74a313c8bed20d4349d9efba356fe6e8ad89e2");
let b = new BigNumber("5bcc0b222ee17877c9eb60fa91632bc7a6e29d80f02cd3fe16b5c2a2231b43db2b2d12f21b293aaf49fe1165cb7a21d12d6acec225285544b36babd3f8b4dd8d");
...
console.log(hexgcd(a.hex, b.hex))
